...
import { useRef, useEffect } from "react"; // Atribui referência a uma variável
...
const Player = ({ duration, randomIdFromArtist, randomId2FromArtist, audio }) => {
    ...
    const [isPlaying, setIsPlaying] = useState(false); // The Music is not playing.
    ...
    const playPause = () => {
        ...
        setIsPlaying(!isPlaying); // True - Its Playing
    ...
    return (
        <div className="player">
            <div className="player__controllers">
                ...
                <FontAwesomeIcon className="player__icon" icon={isPlaying ? faCirclePause : faCirclePlay} onClick={() => playPause()} />
